...
5. (pending) Publication reconciliation: report.md == genome.json fitness, meta.json, greedy-vs-MCTS means explicit.
6. (pending) Rulebook truth: dead card-point tables, inert scoring-borrow ads, rounds>=2 mutation coupling.
