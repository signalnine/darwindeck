...
**File:** `src/darwindeck/genome/actions.py`
...
**File:** `src/darwindeck/genome/conditions.py`
...
**File:** `src/darwindeck/simulation/movegen.py`
...
**File:** `src/darwindeck/evolution/fitness_full.py` (NEW)
...
**File:** `src/darwindeck/evolution/population.py` (NEW)
...
**File:** `src/darwindeck/evolution/operators.py` (NEW)
...
1. `src/darwindeck/evolution/fitness_full.py` - Full fitness evaluator with constraints
2. `src/darwindeck/evolution/population.py` - Population with diversity tracking
3. `src/darwindeck/evolution/operators.py` - Mutation operator system
...
1. `src/darwindeck/genome/schema.py` - Core fixes + trick-taking extension
2. `src/darwindeck/genome/actions.py` - Trick-taking actions
3. `src/darwindeck/genome/conditions.py` - Trick-taking + pattern matching conditions
4. `src/darwindeck/genome/examples.py` - Hearts example genome
...
7. `src/darwindeck/simulation/movegen.py` - Pattern matching functions
