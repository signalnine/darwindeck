...
func main() {
	...
	names := []string{"shedding", "climbing", "banking", "casino", "trick", "rummy", "vying"}
	...
	fmt.Printf("  modifiers: run_play(+climbing combos), follow_suit, draw_penalty, knock, meld_bonus, avoidance, trump, skip, force_draw, wild(rummy), bid, teams, nominate, reverse, sum_capture\n")
