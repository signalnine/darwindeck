...
Deal 5 cards to each player. The first player leads.
...
- **Draw penalty:** whenever you play a face card (Jack or higher), you must immediately draw 1 extra card from the deck
- **Draw penalty:** whenever you play a face card (Jack or higher), you must immediately draw 1 extra card from the deck
