...
- Decision density: 0.37 (37% of turns have meaningful choices)
- Game arc: 0.68
- Interaction: 1.00
- Skill gradient: 0.54
- Session length: 1.00
...
**Fitness provenance:**
- Headline fitness 0.669 is the greedy-only running mean (1 evals) -- the leaderboard ranking key for every published game
