...
- Decision density: 0.24 (24% of turns have meaningful choices)
- Game arc: 0.78
- Interaction: 1.00
- Skill gradient: 0.67
- Session length: 0.84
...
**Fitness provenance:**
- Headline fitness 0.673 is the greedy-only running mean (1 evals) -- the leaderboard ranking key for every published game
