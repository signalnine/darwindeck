## gen60_86438 — Fitness 0.650

**Quick Take:** A shedding game with borrowed mechanics, meld bonuses, penalty cards, 6 special card effects

**Stats:**
- Skeleton: shedding
- Players: 4, Hand size: 10
- Decision density: 0.59 (59% of turns have meaningful choices)
- Game arc: 0.65
- Interaction: 1.00
- Skill gradient: 0.31
- Session length: 0.79
...
- Borrows borrowed mechanics from climbing skeleton
- Borrows meld bonuses from rummy skeleton
- Borrows penalty cards from trick_taking skeleton

**Fitness provenance:**
- Headline fitness 0.650 is the greedy-only running mean (1 evals) -- the leaderboard ranking key for every published game
