...
**Fitness provenance:**
- Published fitness 0.880 is the MCTS-mode mean (1 two-tier evals)
- Greedy-only mean: 0.778 (1 evals -- the selection/decile ranking key)
- MCTS uplift: +0.103 (the second skill tier and fresh batches; large gaps on low-skill games are the knock-timing hazard -- see pkg/fitness)
