...
- Decision density: 0.38 (38% of turns have meaningful choices)
- Game arc: 0.76
- Interaction: 1.00
- Skill gradient: 0.72
- Session length: 0.89
...
**Fitness provenance:**
- Published fitness 0.717 is the greedy-only mean (1 evals); no MCTS tier was granted
