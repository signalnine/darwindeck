## gen194_86457 — Fitness 0.879

**Quick Take:** A shedding game with 6 special card effects

**Stats:**
- Skeleton: shedding
- Players: 2, Hand size: 10
- Decision density: 0.72 (72% of turns have meaningful choices)
- Game arc: 0.92
- Interaction: 0.85
- Skill gradient: 0.34
- Session length: 1.00
...
**Fitness provenance:**
- Published fitness 0.879 is the MCTS-mode mean (1 two-tier evals)
- Greedy-only mean: 0.748 (1 evals -- the selection/decile ranking key)
- MCTS uplift: +0.132 (the second skill tier and fresh batches; large gaps on low-skill games are the knock-timing hazard -- see pkg/fitness)
