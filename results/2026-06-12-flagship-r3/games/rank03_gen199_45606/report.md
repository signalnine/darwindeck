...
**Fitness provenance:**
- Published fitness 0.883 is the MCTS-mode mean (1 two-tier evals)
- Greedy-only mean: 0.785 (1 evals -- the selection/decile ranking key)
- MCTS uplift: +0.098 (the second skill tier and fresh batches; large gaps on low-skill games are the knock-timing hazard -- see pkg/fitness)
